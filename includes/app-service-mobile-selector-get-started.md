> [AZURE.SELECTOR]
- [Android-alapú](../articles/app-service-mobile/app-service-mobile-android-get-started.md)
...
- [A Windows](../articles/app-service-mobile/app-service-mobile-windows-store-dotnet-get-started.md)
