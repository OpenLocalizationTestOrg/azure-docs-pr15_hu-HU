> [AZURE.SELECTOR]
- [Portal (Linux fürthöz)](../articles/hdinsight/hdinsight-administer-use-portal-linux.md)
- [Portal (Windows fürthöz)](../articles/hdinsight/hdinsight-administer-use-management-portal.md)
