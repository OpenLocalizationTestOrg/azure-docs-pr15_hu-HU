<properties
    pageTitle="A gép algoritmus csal lap tanulási |} Microsoft Azure"
    description="Egy nyomtatható gépi tanulási algoritmus csal lapon válassza ki a cserélendő modell jobb algoritmus az Azure gépi tanulási Studio segítségével."
    keywords="algoritmus csal lap csal lap gépi tanulási algoritmus"
...
# <a name="machine-learning-algorithm-cheat-sheet-for-microsoft-azure-machine-learning-studio"></a>Gépi tanulási algoritmus csal lap Microsoft Azure gépi tanulási Studio

A **Microsoft Azure gépi tanulási algoritmus Cheat lap** segítségével válassza ki a megfelelő algoritmust prediktív analytics modell.

[Azure gépi tanulási Studio](https://studio.azureml.net/) egy nagyméretű tárat a ***regressziós***, ***osztályozási***, ***fürtözés***és ***rendellenességet észlelési*** családok algoritmusok tartalmaz. Minden más típusú gépi tanulási probléma megoldására lett tervezve.


## <a name="download-machine-learning-algorithm-cheat-sheet"></a>Letöltés: Gépi tanulási algoritmus csal lap

**Töltse le a csal lap itt: [Gépi tanulási algoritmus Cheat lap (11 x 17 hüvelyk)](http://download.microsoft.com/download/A/6/1/A613E11E-8F9C-424A-B99D-65344785C288/microsoft-machine-learning-algorithm-cheat-sheet-v6.pdf)**

![Gépi tanulási algoritmus csal lap: megtudhatja, hogyan választhatja ki a gépi tanulási algoritmus.][cheat-sheet]

[cheat-sheet]: ./media/machine-learning-algorithm-cheat-sheet/machine-learning-algorithm-cheat-sheet-small_v_0_6-01.png

Töltse le és a gépi tanulási algoritmus Cheat lap nyomtatása tabloid méretű praktikus megőrzése, és kérjen segítséget a algoritmus kiválasztása.

> [AZURE.NOTE] A cikk [a Microsoft Azure gépi tanulási algoritmusok kiválasztásáról](machine-learning-algorithm-choice.md) talál részletes útmutató csal lap használatával.

## <a name="more-help-with-algorithms"></a>További segítséget algoritmusok

* A különböző típusú gépi tanulási algoritmusok, hogyan által használt és csal lap használatáról a megfelelő algoritmus kiválasztásának mélyebb ismertetéséhez elolvashatja, [hogyan választhatja ki a Microsoft Azure gépi tanulási algoritmusok](machine-learning-algorithm-choice.md).
