<properties
   pageTitle="SQL-adatraktár rendszer nézetek |} Microsoft Azure"
   description="Rendszer mutató hivatkozásokat tartalma SQL adatraktár nézeteinek."
...
# <a name="system-views"></a>Rendszer-nézetek

## <a name="sql-data-warehouse-catalog-views"></a>SQL-adatraktár katalógus nézetek
...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>SQL-adatraktár dinamikus kezelése nézetek (DMVs)
...
## <a name="sql-server-dmvs-applicable-to-sql-data-warehouse"></a>Az SQL Server DMVs SQL adatraktár alkalmazandó

A következő DMVs SQL adatraktár alkalmazható, de úgy, hogy a **fő** adatbázishoz való csatlakozáskor végre kell hajtani.

- [sys.database_service_objectives](https://msdn.microsoft.com/library/mt712619.aspx)
- [sys.dm_operation_status](https://msdn.microsoft.com/library/dn270022.aspx)
- [sys.fn_helpcollations()](https://msdn.microsoft.com/library/ms187963.aspx)

## <a name="sql-server-catalog-views"></a>Az SQL Server katalógus nézetek
...
## <a name="sql-server-dmvs-available-in-sql-data-warehouse"></a>Az SQL Server DMVs érhető el az SQL adatraktár

SQL-adatraktár közzététele számos SQL Server management dinamikus nézetek (DMVs). Ezek a nézetek, amikor SQL adatraktár, ad olyan jelenteni állapotát a felosztás futó SQL-adatbázisait.

SQL-adatraktár épül a Microsoft MPP-technológia, mivel a SQL adatraktár és a párhuzamos adatok raktári elemzési Platform rendszer (PDW) a azonos rendszer nézetek használata.

Ez az az oka annak, hogy minden e DMV legyen-e egy adott oszlop neve pdw_node_id. Ez a azonosítóját a számítási csomópontot. A párhuzamos Adatraktárhoz a számítási csomópont fogalma erősebb az architektúra. Az SQL-adatraktár architektúráját támaszkodik további erősen a terjesztését.

>[AZURE.NOTE] Következő nézet használata, szúrjon be "pdw_nodes_" a nevét, az alábbi táblázatban látható módon.


| Az SQL adatraktár DMV neve | A témakör az SQL Server Transact-SQL nyelvben MSDN mutató hivatkozás |
| :----------------------------- | :-------------------------------------------- |
...
| sys.dm_pdw_nodes_os_dispatchers | A Transact-SQL nyelvben dokumentáció nem érhető el. |
...
| sys.dm_pdw_nodes_os_memory_node_access_stats | A Transact-SQL nyelvben dokumentáció nem érhető el. |
...
| sys.dm_pdw_nodes_os_spinlock_stats | A Transact-SQL nyelvben dokumentáció nem érhető el. |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-data-warehouse"></a>Az SQL Server 2016 PolyBase DMVs érhető el az SQL adatraktár
...
- [ELJÁRÁSOK](https://msdn.microsoft.com/library/ms188757.aspx)
