...
Ebben az oktatóanyagban segít egyszerű HTML + CSS webes alkalmazások terjesztése [Azure alkalmazás](../app-service/app-service-value-prop-what-is.md)szolgáltatásba.
...
- HTML- és CSS telepítse azt.
- Lásd: az operációs rendszert futtató élő gyártási oldalak.
- Frissítse a tartalom [mely számjegy véglegesíti leküldéses](https://git-scm.com/docs/git-push)ugyanúgy.
...
## <a name="deploy-a-simple-html-site"></a>Egy egyszerű HTML-webhely üzembe
